...
use App\Http\Middleware\RedirectIfAdvertiser;
use App\Http\Middleware\RedirectIfAuthenticated;
use App\Http\Middleware\RedirectIfNotAdmin;
use App\Http\Middleware\RedirectIfNotAdvertiser;
use App\Http\Middleware\RedirectIfNotPublisher;
use App\Http\Middleware\RedirectIfPublisher;
...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware) {
        ...
        $middleware->alias([
            ...
            'publisher' => RedirectIfNotPublisher::class,
            'publisher.guest' => RedirectIfPublisher::class,

            'advertiser' =>RedirectIfNotAdvertiser::class,
            'advertiser.guest' =>RedirectIfAdvertiser::class,
