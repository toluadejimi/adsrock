...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('ManageCountryController')->name('country.')->prefix('country')->group(function () {
        //country
        Route::get('list', 'countryList')->name('list');
        Route::post('store/{id?}', 'countryStore')->name('store');
        Route::post('status/{id}', 'countryStatus')->name('status');
    });

    // Advertise (AD)


    Route::name('advertise.')->group(function () {
        Route::controller('AdvertiseController')->prefix('advertise')->group(function () {
            ...
            Route::get('manage-cost', 'perCost')->name('per.cost');
            Route::post('cpc-cpm/{id?}', 'perCostStoreUpdate')->name('per.cost.store');
        });

        Route::controller('TypeController')->prefix('type')->group(function () {
            Route::get('/', 'type')->name('type');
            Route::post('store/{id?}', 'storeADType')->name('type.store');
            Route::post('status/{id}', 'typeStatus')->name('type.status');
        });

        Route::controller('ManageIpController')->prefix('ip')->group(function () {
            Route::get('/', 'ipLog')->name('ip.log');
            Route::get('blocked-log', 'blockedIpLog')->name('blocked.ip');
            Route::post('block/{id}', 'blockIp')->name('ip.block');
            Route::post('unblock/{id}', 'unBlockIp')->name('ip.unblock');
        });

        #price-plan
        Route::controller('PlanController')->prefix('plan-price')->group(function () {
            Route::get('/', 'planPrice')->name('plan.price');
            Route::post('store/{id?}', 'storePricePlan')->name('plan.price.store');
            Route::post('status/{id}', 'planPriceStatus')->name('plan.price.status');
        });

        // keywords
        Route::controller('KeywordController')->prefix('keyword')->group(function () {
            Route::get('/', 'keyword')->name('keyword');
            Route::post('store/keyword/{id?}', 'storeKeyword')->name('keyword.store');
            Route::post('remove/keyword/{id}', 'removeKeyword')->name('keyword.remove');
        });
    });
    ...
    Route::controller('ManageAdvertisersController')->name('advertiser.')->prefix('advertiser')->group(function () {
        ...
        Route::get('active/all', 'activeAdvertisers')->name('active');
        Route::get('banned', 'bannedUsers')->name('banned');
        Route::get('detail/{id}', 'advertiserDetails')->name('detail');
        Route::post('update/{id}', 'update')->name('update');
        Route::get('banned/all', 'allBannedAdvertiser')->name('banned.all');

        Route::post('add-sub-balance/{id}', 'addSubBalance')->name('add.sub.balance');

        Route::get('email-unverified', 'emailUnverifiedAdvertisers')->name('email.unverified');
        Route::get('mobile-unverified', 'mobileUnverifiedAdvertisers')->name('mobile.unverified');
    ...
    Route::controller('ManagePublishersController')->name('publisher.')->prefix('publisher')->group(function () {
        ...
        Route::get('banned', 'bannedUsers')->name('banned');
        Route::get('detail/{id}', 'publisherDetails')->name('detail');
        Route::post('update/{id}', 'update')->name('update');
        Route::get('banned/all', 'allBannedPublisher')->name('banned.all');

        Route::post('add-sub-balance/{id}', 'addSubBalance')->name('add.sub.balance');

        Route::get('kyc-unverified', 'kycUnverifiedPublishers')->name('kyc.unverified');
        Route::get('kyc-pending', 'kycPendingPublishers')->name('kyc.pending');
        Route::get('email-unverified', 'emailUnverifiedPublishers')->name('email.unverified');
        Route::get('mobile-unverified', 'mobileUnverifiedPublishers')->name('mobile.unverified');
    ...
    Route::controller('ReportController')->prefix('report')->name('report.')->group(function () {
        Route::get('earning/log', 'publisherEarningLog')->name('earning.log');
        Route::get('transaction/{id?}', 'transaction')->name('transaction');
        Route::get('login/history/advertiser', 'loginHistoryAdvertiser')->name('login.history.advertiser');
        Route::get('login/history/publisher', 'loginHistoryPublisher')->name('login.history.publisher');
    ...
    Route::controller('GeneralSettingController')->group(function () {
        ...
        // manage tracker
        Route::get('country-detector', 'countryDetectorSetting')->name('country.detector');
        Route::post('country-detector', 'countryDetectorUpdate')->name('country.detector.update');
    });
