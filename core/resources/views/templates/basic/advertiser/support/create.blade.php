                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="subject" placeholder="@lang('Subject')"
                                    value="{{ old('subject') }}" class="form-control form--control" required>
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="col-12 form-group">
                                ...
                                <textarea name="message" placeholder="@lang('Message')" id="inputMessage" rows="6"
                            ...
                            <div class="col-md-3">
                                <button class="btn btn--base btn--sm w-100 my-2" type="submit"><i class="las la-paper-plane"></i>
                                    @lang('Submit')
                                </button>
                            </div>
                        </div>
