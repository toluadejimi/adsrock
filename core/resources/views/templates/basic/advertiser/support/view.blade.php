        ...
        <div class="col-md-12">
            <div class="card custom--card">
                <div class="card-header  py-3 d-flex flex-wrap justify-content-between align-items-center gap-2">
                    ...
                    @if ($myTicket->status != Status::TICKET_CLOSE && $myTicket->advertiser)
                        <button class="btn btn-outline--danger btn--sm close-button btn-sm confirmationBtn" type="button"
                            data-question="@lang('Are you sure to close this ticket?')" data-action="{{ route('ticket.close', $myTicket->id) }}">
                            <i class="la la-times-circle"></i> @lang('Close Ticket')
                        </button>
                    @endif
                </div>
                <div class="card-body">
                        ...
                        <div class="row justify-content-between">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <textarea name="message" placeholder="@lang('Message')" class="form-control form--control" rows="4" required>{{ old('message') }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-9">
                            ...
                            <div class="col-md-3">
                                <button class="btn btn--base w-100 my-2 btn--sm" type="submit">
