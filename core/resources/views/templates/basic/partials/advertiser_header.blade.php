      ...
      <div class="user-info">
        <button class="user-info__button flex-align">
          <span class="user-info__thumb">
            <img src="{{ getImage(getFilePath('advertiserProfile') .'/' .auth()->guard('advertiser')->user()->image) }}" class="fit-image" alt="@lang('profileImage')" />
          </span>
         {{__(auth()->guard('advertiser')->user()->username)}}
        </button>
        <ul class="user-info-dropdown">
         
          <li class="user-info-dropdown__item">
            <a class="user-info-dropdown__link" href="{{ route('advertiser.profile.setting') }}">
          ...
          <li class="user-info-dropdown__item">
            <a class="user-info-dropdown__link" href="{{ route('advertiser.change.password') }}">
          ...
          <li class="user-info-dropdown__item">
            <a class="user-info-dropdown__link" href="{{ route('advertiser.logout') }}">
