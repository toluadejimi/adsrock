        ...
        <div class="col-md-6">
            ...
            @if (auth()->guard('publisher')->user()->ts)
                <div class="card custom--card">
                    ...
                    <form action="{{ route('publisher.twofactor.disable') }}" method="POST">
                        <div class="card-body">
                            @csrf
                            <input type="hidden" name="key" value="{{ $secret }}">
                            <div class="form-group">
                                <label class="form--label">@lang('Google Authenticator OTP')</label>
                                <input type="text" class=" form--control" placeholder="@lang('Google Authenticator OTP')" name="code"
                                    required>
                            </div>
            ...
            @else
                <div class="card custom--card">
                    ...
                    <form action="{{ route('publisher.twofactor.enable') }}" method="POST">
                        <div class="card-body">
                            @csrf
                            <input type="hidden" name="key" value="{{ $secret }}">
                            <div class="form-group">
