            ...
            <div class="account-inner__left">
                <div class="account-form-wrapper">
                    <div class="text-center">
                        ...
                        <p class="account-form__text">@lang('To recover your account please provide your email or username to find your account.')</p>
                    </div>

                    <form method="POST" action="{{ route('publisher.password.email') }}" class="verify-gcaptcha">
                        @csrf
