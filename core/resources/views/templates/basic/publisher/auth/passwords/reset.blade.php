    ...
    <div class="account-inner">
        <div class="account-inner__left">
            <div class="account-form-wrapper">
                ...
                <form method="POST" action="{{ route('publisher.password.update') }}">
                    @csrf
                    ...
                    <div class="account-form">
                        <div class="row">
                            ...
                            <div class="col-sm-12  form-group">
                                ...
                                <input type="password" class="form-control form--control" placeholder="@lang("Confrim Passwird")" name="password_confirmation"
                                    required>
                            </div>
