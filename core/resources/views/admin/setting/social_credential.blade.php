            ...
            <div class="modal-content">
                ...
                <form method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>@lang('Callback URL for Publisher')</label>
                        ...
                        <div class="form-group">
                            <label>@lang('Callback URL for Advertiser')</label>
                            <div class="input-group">
                                <input type="text" class="form-control callback2" readonly>
                                <button type="button" class="input-group-text copyInput" title="@lang('Copy')">
                                    <i class="las la-clipboard"></i>
                                </button>
                            </div>
    ...
    <script>
        (function($) {
            ...
            $(document).on('click', '.editBtn', function() {
                ...
                let callbackUrl = "{{ route('publisher.social.login.callback', '') }}";
                let callbackUrl2 = "{{ route('advertiser.social.login.callback', '') }}";
                ...
                modal.find('.callback2').val(`${callbackUrl2}/${data.key}`);
                modal.modal('show');
            });
