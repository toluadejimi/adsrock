                        ...
                        <table class="table table--light style--two">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <br>
                                    <span class="small">
                                    <a href="{{ route('admin.advertiser.detail', $user->id) }}"><span>@</span>{{ $user->username }}</a>
                                    </span>
                                </td>
                                ...
                                <td>
                                    <div class="button--group">
                                        <a href="{{ route('admin.advertiser.detail', $user->id) }}" class="btn btn-sm btn-outline--primary">
