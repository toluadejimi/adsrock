                            ...
                            <tbody>
                                @forelse($logs as $log)
                                    <tr>
                                        <td>
                                            @if ($log->publisher)
                                                <span class="fw-bold">{{ $log->publisher->name }}</span>
                                                <br>
                                                <span class="small">
                                                    <a
                                                        href="{{ route('admin.publisher.detail', $log->advertiser_id) }}"><span>@</span>{{ $log->publisher->username }}</a>
                                                </span>
                                            @else
...
@push('breadcrumb-plugins')
    @if (@$publisher)
        <a href="{{ route('admin.publisher.notification.single', $publisher->id) }}"
