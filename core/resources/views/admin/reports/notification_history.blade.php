...
@push('breadcrumb-plugins')
    @if(@$advertiser)
        <a href="{{ route('admin.advertiser.notification.single',$advertiser->id) }}" class="btn btn-outline--primary btn-sm"><i class="las la-paper-plane"></i> @lang('Send Notification')</a>
    @else
