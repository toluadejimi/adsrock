                    ...
                    <table class="table table--light style--two">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="fw-bold">{{ $withdraw->publisher->fullname }}</span>
                                    <br>
                                    <span class="small"> <a href="{{ appendQuery('search',@$withdraw->user->username) }}"><span>@</span>{{ $withdraw->publisher->username }}</a> </span>
                                </td>
