...
class SupportTicketController extends Controller
{
    ...
    public function tickets()
    {
        ...
        $items = SupportTicket::searchable(['name','subject','ticket'])->orderBy('id','desc')->with('advertiser', 'publisher')->paginate(getPaginate());
    ...
    public function pendingTicket()
    {
        ...
        $items = SupportTicket::searchable(['name','subject','ticket'])->pending()->orderBy('id','desc')->with('advertiser', 'publisher')->paginate(getPaginate());
        return view('admin.support.tickets', compact('items', 'pageTitle'));
    }
    ...
    public function closedTicket()
    {
        ...
        $items = SupportTicket::searchable(['name','subject','ticket'])->closed()->orderBy('id','desc')->with('advertiser', 'publisher')->paginate(getPaginate());
        return view('admin.support.tickets', compact('items', 'pageTitle'));
    }
    ...
    public function answeredTicket()
    {
        ...
        $items = SupportTicket::searchable(['name','subject','ticket'])->orderBy('id','desc')->with('advertiser', 'publisher')->answered()->paginate(getPaginate());
        return view('admin.support.tickets', compact('items', 'pageTitle'));
    }
