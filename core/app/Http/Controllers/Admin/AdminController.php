...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        // User Info
        $widget['total_users']             = 0;
        $widget['verified_users']          = 0;
        $widget['email_unverified_users']  = 0;
        ...
        //Publisher Info
        $widget['total_publishers']             = Publisher::count();
        $widget['verified_publishers']          = Publisher::active()->count();
        $widget['email_unverified_publishers']  = Publisher::emailUnverified()->count();
        $widget['mobile_unverified_publishers'] = Publisher::mobileUnverified()->count();
        ...
        $widget['total_ads']  = Advertise::active()->count();
        $widget['ad_type']    = AdType::where('status', Status::ENABLE)->count();
        $widget['total_plan'] = PlanPrice::count();

        $widget['approved_domain']   = Domain::where('status', Status::DOMAIN_VERIFIED)->count();
        $widget['pending_domain']    = Domain::where('status', Status::DOMAIN_PENDING)->count();
        $widget['total_click']      = Advertise::sum('clicked');
        $widget['total_impression'] = Advertise::sum('impression');
    ...
    {
        $notifications = AdminNotification::orderBy('id', 'desc')->with('advertiser','publisher')->paginate(getPaginate());
