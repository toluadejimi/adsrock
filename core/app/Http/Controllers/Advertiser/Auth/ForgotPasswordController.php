...
class ForgotPasswordController extends Controller
{
    ...
    public function showLinkRequestForm()
    {
        ...
        return view('Template::advertiser.auth.passwords.email', compact('pageTitle'));
    }
    ...
    public function codeVerify()
    {
        ...
        return view('Template::advertiser.auth.passwords.code_verify', compact('pageTitle', 'email'));
    }
